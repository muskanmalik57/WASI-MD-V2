...
global.userImages = process.env.USER_IMAGES || "https://telegra.ph/file/a14541d095a9e7fa3f63e.jpg";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "GURIYA 🥰 RANI😘",
  author: process.env.PACK_AUTHER || "RANI☺️",
  packname: process.env.PACK_NAME || "GURIYA 💝",
  botname: process.env.BOT_NAME || "GURIYA JAAN😘💓",
  ownername: process.env.OWNER_NAME || "RANI😘🖤",
  errorChat: process.env.ERROR_CHAT || "+923111597404",
  ...
  LANG: (process.env.THEME || "RANI JAN😍❤️").toUpperCase(),
};
global.rank = "updated";
